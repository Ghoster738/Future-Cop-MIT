...
bool Data::Mission::ACT::Aircraft::readACTType( uint_fast8_t act_type, Utilities::Buffer::Reader &data_reader, Utilities::Buffer::Endian endian ) {
    ...
    internal.uint8_3 = data_reader.readU8(); // Values: 0, 1, 2, 3, 8, 12,
    internal.uint16_1 = data_reader.readU16( endian ); // Values: 8192, 16384, 24576, 28672, 32358,
    ...
    internal.uint16_4 = data_reader.readU16( endian ); // Values: 512, 716, 737, 819, 901, 921, 1126, 1331, 1433,
    internal.uint16_5 = data_reader.readU16( endian ); // Values: 737, 901, 1024, 1228, 1433, 1556, 1638,
    internal.uint16_6 = data_reader.readU16( endian ); // Values: 3072, 3276, 4915, 5120, 5324, 8192,
    internal.uint16_7 = data_reader.readU16( endian ); // Values: 1433, 1638, 1843, 2048, 2457,
    internal.uint16_8 = data_reader.readU16( endian ); // Values: 4096, 5734, 8192, 12288, 15564, 16384, 20480, 24576, 30720, 31744, 32727, 32763,
    internal.uint16_9 = data_reader.readU16( endian ); // Values: 3686, 4096, 4915, 8192, 10240, 12288, 16384, 20480, 24576, 28672, 31744, 32763,
    ...
    internal.uint16_12 = data_reader.readU16( endian ); // Values: 0, 1168, 1217, 1285, 1343, 1515, 1632, 1637, 1693, 1745, 1873, 1904, 1905, 1971, 1979, 1984, 2144, 2163, 2178,
    internal.uint16_13 = data_reader.readU16( endian ); // Values: 0, 1183, 1193, 1203, 1232, 1504, 1600, 1612, 1681, 1983, 1984, 2118, 2173, 2279, 2315, 2317, 2320, 2374, 2392, 2563, 2629,
