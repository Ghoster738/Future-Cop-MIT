...
bool Data::Mission::ACT::MapObjectiveNodeGroup::readACTType( uint_fast8_t act_type, Utilities::Buffer::Reader &data_reader, Utilities::Buffer::Endian endian ) {
    ...
    internal.uint16_5 = data_reader.readU16( endian ); // Values: 1136, 1215, 1249, 1406, 1535, 1667, 1772, 1857, 1922, 2047, 2048, 2080, 2158, 2796, 2953, 
    internal.uint16_6 = data_reader.readU16( endian ); // Values: 1141, 1280, 1528, 1821, 1975, 2001, 2047, 2048, 2176, 2224, 2387, 2431, 2503, 2671, 
    internal.uint16_7 = data_reader.readU16( endian ); // Values: 1206, 1244, 1247, 1410, 1535, 1665, 1728, 1736, 2048, 2167, 2168, 2181, 2534, 3160, 3200, 
    internal.uint16_8 = data_reader.readU16( endian ); // Values: 1166, 1191, 1397, 1675, 1845, 1857, 1865, 1953, 1960, 2121, 2414, 2430, 2703, 2920, 3330, 
    internal.uint16_9 = data_reader.readU16( endian ); // Values: 1206, 1406, 1528, 1648, 1712, 1833, 1901, 1905, 2030, 2127, 2173, 2434, 2481, 2699, 
    internal.uint16_10 = data_reader.readU16( endian ); // Values: 1133, 1411, 1417, 1473, 1535, 1646, 1775, 1904, 1920, 1980, 2160, 2177, 2398, 2992, 3066, 
    internal.uint16_11 = data_reader.readU16( endian ); // Values: 0, 1155, 1168, 1345, 1523, 1619, 1673, 1703, 1743, 1920, 2048, 2123, 2240, 
    internal.uint16_12 = data_reader.readU16( endian ); // Values: 0, 1133, 1251, 1256, 1408, 1414, 1535, 1664, 1755, 1917, 1922, 1975, 2583, 2839, 
    internal.uint16_13 = data_reader.readU16( endian ); // Values: 0, 1158, 1168, 1405, 1511, 1617, 1663, 1942, 2099, 2293, 2351, 2493, 3200, 
    internal.uint16_14 = data_reader.readU16( endian ); // Values: 0, 1213, 1408, 1700, 1729, 1814, 2048, 2176, 2353, 2426, 2432, 2632, 2688, 2705, 
    internal.uint16_15 = data_reader.readU16( endian ); // Values: 0, 1763, 1904, 1977, 2102, 2149, 2172, 2416, 2432, 2482, 2689, 3192, 3199, 
    internal.uint16_16 = data_reader.readU16( endian ); // Values: 0, 1145, 1295, 1382, 1431, 1471, 1473, 2047, 2169, 2304, 2429, 2560, 2688, 2713, 
    internal.uint16_17 = data_reader.readU16( endian ); // Values: 0, 1633, 1647, 1872, 2102, 2480, 2560, 
    internal.uint16_18 = data_reader.readU16( endian ); // Values: 0, 1145, 1238, 1259, 1493, 1600, 1856, 2305, 
    internal.uint16_19 = data_reader.readU16( endian ); // Values: 0, 1383, 1408, 1635, 
    internal.uint16_20 = data_reader.readU16( endian ); // Values: 0, 1408, 1583, 1664, 2047, 
