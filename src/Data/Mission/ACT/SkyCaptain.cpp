...
bool Data::Mission::ACT::SkyCaptain::readACTType( uint_fast8_t act_type, Utilities::Buffer::Reader &data_reader, Utilities::Buffer::Endian endian ) {
    ...
    internal.spawn_type = data_reader.readU8(); // Values: 0, 8, 12,
    ...
    internal.spawn_pos_x = data_reader.readU16( endian ); // Values: 0, 1920, 2049, 3303,
    internal.spawn_pos_y = data_reader.readU16( endian ); // Values: 0, 1912, 2799, 3537,
