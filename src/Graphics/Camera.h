...
protected:
    ...
    Utilities::DataTypes::Mat4 projection3D;
    Utilities::DataTypes::Mat4 view3D;
    Utilities::DataTypes::Mat4 PV3D;

    // These are for the 2D environment which would mostly be used for GUI.
    Utilities::DataTypes::Mat4 projection2D;
    Utilities::DataTypes::Mat4 view2D;
    Utilities::DataTypes::Mat4 PV2D;

    // Viewport locations
    Utilities::DataTypes::Vec2UInt origin;
...
public:
     ...
     */
    void setProjection3D( const Utilities::DataTypes::Mat4 &projection3D );
     ...
     */
    void setView3D( const Utilities::DataTypes::Mat4 &view3D );
     ...
     * @param view3D sets the view of this camera's 3D mode.
     */
    void setProjectionView3D( const Utilities::DataTypes::Mat4 &projection3D, const Utilities::DataTypes::Mat4 &view3D );
     ...
     */
    void setProjection2D( const Utilities::DataTypes::Mat4 &projection2D );
     ...
     */
    void setView2D( const Utilities::DataTypes::Mat4 &view2D );

    /**
     * This is to set the viewport origin.
     * @param origin This sets the origin of the viewport.
     */
    void setViewportOrigin( const Utilities::DataTypes::Vec2UInt &origin );
     ...
     */
    void setViewportDimensions( const Utilities::DataTypes::Vec2UInt &dimensions );
     ...
     */
    Utilities::DataTypes::Vec2UInt getViewportOrigin() const;

    /**
     * @param dimensions the dimensions of the viewport.
     */
    Utilities::DataTypes::Vec2UInt setViewportDimensions() const;
