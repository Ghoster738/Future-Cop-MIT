...
void ImageDraw::updateImageData(uint32_t cbmp_id, const ImageData *const image_r, const ImageData& image_data) {}

void ImageDraw::removeImageData(uint32_t cbmp_id, const ImageData *const image_r) {}
