...
const GLchar* Graphics::SDL2::GLES2::Internal::StaticModelDraw::default_fragment_shader =
    ...
    "void main()\n"
    "{\n"
    "  gl_FragColor = texture2D(Shine, world_reflection.xz) * specular + texture2D(Texture, texture_coord_1);\n"
    "}\n";
...
int Graphics::SDL2::GLES2::Internal::StaticModelDraw::inputModel( Utilities::ModelBuilder *model_type, int index, const std::vector<Internal::Texture2D*> textures ) {
    int state = 0;
