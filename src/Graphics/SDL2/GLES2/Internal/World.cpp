...
const GLchar* Graphics::SDL2::GLES2::Internal::World::default_fragment_shader =
    ...
    "    if( frag_color.r < CUTOFF && frag_color.g < CUTOFF && frag_color.b < CUTOFF && frag_color.a < CUTOFF )"
    "       discard;\n"
    "    if( frag_color.a > CUTOFF ) {\n"
    "        frag_color.a = max( frag_color.r, frag_color.g );\n"
    "        frag_color.a = max( frag_color.b, frag_color.a );\n"
    "    } else\n"
    "        frag_color.a = 1.0;\n"
