...
void MapSelectorMenu::load( MainProgram &main_program ) {
    ...
    this->items[ Data::Manager::AMOUNT_OF_IFF_IDS + 0 ] = Menu::Item( "Back",     glm::vec2( 0, (Data::Manager::AMOUNT_OF_IFF_IDS + 1) * 24 ), &items[ Data::Manager::AMOUNT_OF_IFF_IDS - 1 ], nullptr, &items[ 0 ], nullptr, exitMapSelector );
    this->items[ Data::Manager::AMOUNT_OF_IFF_IDS + 1 ] = Menu::Item( this->name, glm::vec2( 0, 0 ), nullptr, nullptr, nullptr, nullptr, nullPress );

    this->items[0] = Menu::Item( *Data::Manager::map_iffs[0], glm::vec2( 0, 24 ), &items[ Data::Manager::AMOUNT_OF_IFF_IDS ], nullptr, &items[ 1 ], nullptr, mapSelect );
    ...
    this->items[ Data::Manager::AMOUNT_OF_IFF_IDS - 1 ] = Menu::Item( *Data::Manager::map_iffs[ Data::Manager::AMOUNT_OF_IFF_IDS - 1 ], glm::vec2( 0, Data::Manager::AMOUNT_OF_IFF_IDS * 24 ), &items[ Data::Manager::AMOUNT_OF_IFF_IDS - 2 ], nullptr, &items[ Data::Manager::AMOUNT_OF_IFF_IDS ], nullptr, mapSelect );
