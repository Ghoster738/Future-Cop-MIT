...
public:
    ...
    const StringParam& export_dir    = p_export_dir;   // The export path to where the exported resources go.
...
private:
    ...
    StringParam p_config_dir;   // Game configuration directory
    StringParam p_export_dir;   // The export path to where the exported resources go.
